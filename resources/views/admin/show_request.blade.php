...
<div class="page-wrapper">
    ...
    <tr>
     ...
     {{-- ✅ START: NEW PDF DOCUMENT ROW --}}
    @if($request->pdf_document_path)
        <tr>
            <th>المستند المرفق (PDF)</th>
            <td>
                <a href="{{ Storage::disk('public')->url($request->pdf_document_path) }}" target="_blank">
